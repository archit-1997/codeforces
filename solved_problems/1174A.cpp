...
so that the sum of the first 𝑛 elements isn't equal to the sum of the last 𝑛
...
If there's no solution, print "-1" (without quotes). Otherwise, print a single
line containing 2𝑛 space-separated integers. They must form a reordering of 𝑎
