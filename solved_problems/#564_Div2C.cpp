...
One day she was playing cards but found that the cards were mixed with some
empty ones.

There are 𝑛
cards numbered from 1 to 𝑛, and they were mixed with another 𝑛 empty cards. She
piled up the 2𝑛 cards and drew 𝑛 of them. The 𝑛 cards in Nauuo's hands are
given. The remaining 𝑛

cards in the pile are also given in the order from top to bottom.

In one operation she can choose a card in her hands and play it — put it at the
bottom of the pile, then draw the top card from the pile.

Nauuo wants to make the 𝑛
numbered cards piled up in increasing order (the 𝑖-th card in the pile from top
to bottom is the card 𝑖
...
integers 𝑏1,𝑏2,…,𝑏𝑛 (0≤𝑏𝑖≤𝑛) — the initial cards in the pile, given in order
...
The output contains a single integer — the minimum number of operations to make
the 𝑛
...
and draw the card 3 in the first operation. After that, we have [0,3,0] in hands
and the cards in the pile are [0,1,2]
