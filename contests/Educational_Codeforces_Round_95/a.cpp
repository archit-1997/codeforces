...
int main() {
  ...
  // now he needs to have k sticks as well, so no of sticks additionally
  // required = k-1 so total no of sticks is ky+k-1 in one iteration, you get
  // additionally (x-1) sticks total number of iterations is (ky+k-1)/(x-1)
